...
//import com.xiaobailong_student.bean.Devices;
//import com.xiaobailong_student.bean.Time_;
//import com.xiaobailong_student.bean.Time_Dao;
...
//        // get data
//        devices = (Devices) getIntent().getSerializableExtra("devices");
//        getData();
...
//        Time_ years = times_s.get(position);
//        yd.delete(years);
//
//        // delete file
//
...
//
//        yd = BaseApplication.app.daoSession.getTime_Dao();
//        times_s = yd.queryBuilder().where(Time_Dao.Properties.Parent.eq(devices.getId())).list();
//
//    }
//
//
...
//        @Override
//        public int getCount() {
//            return times_s == null ? 0 : times_s.size();
//        }
//
//        @Override
...
//            if (convertView == null) {
//                convertView = LayoutInflater.from(TimeActivity.this).inflate(R.layout.item_grid_year, null);
...
//                        }
//                        // add file
//                        File dirs = new File(devices.getPath());
//                        if (!dirs.exists()) {
//                            dirs.mkdirs();
//                        }
//
...
//                        }
//                        // add data base;
//                        Time_ years = new Time_();
//                        years.setFilename(filename);
//                        years.setParent(devices.getId());
//                        years.setPath(newFile.getAbsolutePath());
//                        yd.insert(years);
//                        List<Time_> datas = yd.queryBuilder().where(Time_Dao.Properties.Parent.eq(devices.getId())).list();
//                        times_s.clear();
//                        adapter.notifyDataSetChanged();
//                        times_s.addAll(datas);
//                        adapter.notifyDataSetChanged();
//                    }
//                }
//            }
...
//                    }
//
//                    Time_ years = times_s.get(editFilePos);
